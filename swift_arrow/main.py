...
from courier.parcels import find_parcel, add_parcel, update_parcel, delete_parcel, find_parcels_by_destination
...
if not logged_in_user:
    ...
    while True:
        ...
        elif slip.lower().startswith("get parcels to "):

            parts = slip.split(maxsplit=3)

            if len(parts) != 4:
                print("400 - USE: GET parcels to <city>")
                continue
        ...
        #----------------------
            ...
            reply = delete_parcel(code, token_user, parcels, tracking_index, destination_index)
